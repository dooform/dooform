    ...
    <div className="font-sans flex flex-col items-start justify-start h-screen rounded-2xl">
      <div className="flex flex-col items-center justify-center w-full py-8 gap-4">
        <div className='flex flex-col items-center justify-center'>
            <p className="text-3xl md:text-6xl md:leading-20 font-semibold text-on-900 text-center">กรอกเอกสาร<br />ไม่ใช่เรื่องยากอีกต่อไป</p>
            <p className="lg:text-xl font-medium text-on-600">ดูฟอร์ม ผู้ช่วยกรอกเอกสารราชการได้อย่างรวดเร็ว</p>
        </div>
